...
Si PaddleOCR te resulta útil para tu investigación, cita **PaddleOCR 3.0** y **PaddleOCR-VL**. Para consultar más artículos, resúmenes de los trabajos y referencias BibTeX, visita la [página de publicaciones de PaddleOCR (en inglés)](../docs/papers.en.md).
